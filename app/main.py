...
# # ============================================================
# # Picking + Excel (nuevo, quirúrgico)
# # ============================================================
...
#         print("[ERROR] Falló carga de excel")
#         print(json.dumps(excel_result, ensure_ascii=False, indent=2))
#         return 2

#     consolidated = match_picking_with_excel(picking_result, excel_result)
...
#         },
#         "match_result": consolidated,
#     }

#     if output_path is None:
#         stem = picking_image.stem
#         output_path = Path("data/picking") / f"{stem}_consolidated.json"

#     save_json(payload, str(output_path))

#     print(f"[OK] Consolidado guardado en: {output_path}")
#     print(json.dumps(payload["match_result"], ensure_ascii=False, indent=2))
#     return 0
